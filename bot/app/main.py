...
app = FastAPI(
    ...
    description="AI assistant for Kerala Government welfare schemes",
    version="1.0"
)
...
def startup_event():
    ...
    print("🚀 Starting Kerala Schemes Chatbot...")
    ...
    try:
        ...
        print(f"✅ Ready with {len(events)} Kerala schemes")
